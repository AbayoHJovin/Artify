...
export default function Landing() {
  ...
  return (
    <div>
      <div className="bg-blue-600 sticky top-0 z-10 w-full">
        ...
        {isOpen && (
          <div className="md:hidden bg-white absolute w-full top-full left-0 shadow-lg z-10">
            <p
      ...
      <div className="bg-[rgb(37,99,235)] text-white w-full">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-center md:text-left md:mr-8 mx-4 md:mx-24 mt-10">
            <h1 className="font-mono text-3xl md:text-6xl mb-3">
              Hello media and{" "}
            </h1>
            <h1 className="font-mono text-3xl md:text-6xl mb-3">
              Entertainment
            ...
            <h1 className="font-mono text-3xl md:text-6xl mb-3">
              <ReactTyped
                strings={["Enthusiast", "users", "lovers"]}
                typeSpeed={120}
                backSpeed={140}
                loop
              />
      ...
      <div className="md:flex items-center px-4 md:px-20 py-10">
